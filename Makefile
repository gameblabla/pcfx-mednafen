...
SRCDIR    = src src/video src/net src/cputest src/trio src/string src/demo src/resampler src/hash src/compress src/desa86 src/drivers 
SRCDIR    += src/hw_cpu src/hw_misc src/hw_video src/mpcdec 
SRCDIR    += src/quicklz src/sound_ src/sexyal src/cdrom src/cdplay 
