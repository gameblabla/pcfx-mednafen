...
CC_OPTS		= -O2 -pg $(F_OPTS) $(DEFINES) -march=native -mtune=native
...
SRCDIR    = src src/video src/cputest src/trio src/string src/demo src/resampler src/hash src/compress src/drivers 
